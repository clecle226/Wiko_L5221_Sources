DEVICE_PACKAGE_OVERLAYS := device/tinno/L5251/overlay
...
PRODUCT_COPY_FILES += \
    device/tinno/L5251/audio_policy.conf:system/etc/audio_policy.conf \
    device/tinno/L5251/audio_effects.conf:system/vendor/etc/audio_effects.conf \
    device/tinno/L5251/mixer_paths_qrd_skuh.xml:system/etc/mixer_paths_qrd_skuh.xml \
    device/tinno/L5251/mixer_paths_qrd_skui.xml:system/etc/mixer_paths_qrd_skui.xml \
    device/tinno/L5251/mixer_paths_msm8909_pm8916.xml:system/etc/mixer_paths_msm8909_pm8916.xml \
    device/tinno/L5251/mixer_paths_skua.xml:system/etc/mixer_paths_skua.xml \
    device/tinno/L5251/mixer_paths_skuc.xml:system/etc/mixer_paths_skuc.xml \
    device/tinno/L5251/mixer_paths_skue.xml:system/etc/mixer_paths_skue.xml \
    device/tinno/L5251/sound_trigger_mixer_paths.xml:system/etc/sound_trigger_mixer_paths.xml \
    device/tinno/L5251/sound_trigger_platform_info.xml:system/etc/sound_trigger_platform_info.xml \
...
PRODUCT_COPY_FILES += \
    device/tinno/L5251/mixer_paths.xml:system/etc/mixer_paths.xml \
    device/tinno/L5251/ftm_test_config:system/etc/ftm_test_config
else
PRODUCT_COPY_FILES += \
    device/qcom/msm8909/mixer_paths.xml:system/etc/mixer_paths.xml 
endif

#parameters for cabl function
PRODUCT_COPY_FILES += \
    device/tinno/L5251/ABLSampleConfig.xml:system/etc/ABLSampleConfig.xml
...
#Tinno:CJ ota
#fenghui.zou remove to L5221_5.0_V9.1/vendor/tinno/L5221/trunk/configs.mk 
...
#wlan driver
PRODUCT_COPY_FILES += \
    device/tinno/L5251/WCNSS_qcom_cfg.ini:system/etc/wifi/WCNSS_qcom_cfg.ini \
    device/tinno/L5251/WCNSS_wlan_dictionary.dat:persist/WCNSS_wlan_dictionary.dat \
    device/tinno/L5251/WCNSS_qcom_wlan_nv.bin:persist/WCNSS_qcom_wlan_nv.bin

#lcd color manager
PRODUCT_COPY_FILES += \
    device/tinno/L5251/pp_calib_data.bin:persist/display/pp_calib_data.bin
