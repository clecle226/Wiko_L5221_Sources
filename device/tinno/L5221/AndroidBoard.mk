...
ifeq ($(KERNEL_DEFCONFIG),)
      ifeq ($(strip $(PROJECT_NAME)),blu_us)
             ifeq ($(TARGET_BUILD_VARIANT),user)
                 KERNEL_DEFCONFIG := L5221BP-perf_defconfig
             else
                 KERNEL_DEFCONFIG := L5221BP_defconfig
             endif
      else
             ifeq ($(TARGET_BUILD_VARIANT),user)
                 KERNEL_DEFCONFIG := L5221-perf_defconfig
             else
                 KERNEL_DEFCONFIG := L5221_defconfig
             endif
      endif
endif
...
#Tinno:CJ
INSTALLED_RADIOIMAGE_TARGET := device/qcom/msm8909/radio/filesmap
