...
TARGET_BOOTLOADER_BOARD_NAME := l5221
...
BOARD_USERDATAIMAGE_PARTITION_SIZE := 1048576000

ifeq ($(strip $(PROJECT_NAME)),wik_fr)
	BOARD_SYSTEMIMAGE_PARTITION_SIZE := 1101004800
endif
ifeq ($(strip $(PROJECT_NAME)),wik_fr)
	BOARD_USERDATAIMAGE_PARTITION_SIZE := 2178940928
endif

ifeq ($(strip $(PROJECT_NAME)),lax_mx)
	BOARD_USERDATAIMAGE_PARTITION_SIZE := 4831838208
endif

ifeq ($(strip $(PROJECT_NAME)),lax_co)
	BOARD_USERDATAIMAGE_PARTITION_SIZE := 4831838208
endif

# BWJ for FCCBLUSA-46 FOTA START
ifeq ($(strip $(PROJECT_NAME)),blu_us)
	#fenghui.zou modified for flash 8g line
	BOARD_USERDATAIMAGE_PARTITION_SIZE := 4831838208

#For fota support
FOTA_UPDATE_SUPPORT := true
#fenghui.zou modified for blu_us fota no icon line
FOTA_UPDATE_WITH_ICON := false
FOTA_UPDATE_WITHOUT_MENU := false
endif

# BWJ for FCCBLUSA-46 FOTA END
