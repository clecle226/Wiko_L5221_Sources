...
ifeq ($(WIKO_PROPERTY),wiko)
    $(warning --[wiko]--WIKO_PROPERTY=$(WIKO_PROPERTY)-- )
    CUST_DIR := vendor/tinno/requirment/wik_share/cp_files
    CDROM_RES_FILE := $(CUST_DIR)/cdrom_res
    $(warning --[wiko]--CDROM_RES_FILE==$(CDROM_RES_FILE)-- )
else
...
define build-cdrom-target
    ...
    $(hide) cp -f $(CDROM_RES_FILE)/cdrom_install.iso $(CDROM_ISO_TARGET)  
endef
