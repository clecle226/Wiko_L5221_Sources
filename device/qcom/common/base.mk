...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/tinno/$(TARGET_PRODUCT)
...
# BWJ for EBBAL-196 delete launcher2
#    Launcher2 \
...
ifeq ($(QCOM_EXREA_DEBUG_APP),true)
PRODUCT_PACKAGES += \
       BTTestApp \
       HiddTestApp
endif

ifeq ($(QCOM_EXREA_APP),true)
PRODUCT_PACKAGES += \
    VoiceDialer \
    QuickSearchBox
endif
