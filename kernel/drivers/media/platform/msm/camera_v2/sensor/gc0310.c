...
static struct msm_camera_i2c_reg_conf gc0310_reg_sharpness[7][3] = {
	...
	{{0xfe, 0x00},{0x95, 0x00},{0xfe, 0x00}},//Sharpness -2
	{{0xfe, 0x00},{0x95, 0x33},{0xfe, 0x00}},//Sharpness -2
	{{0xfe, 0x00},{0x95, 0x55},{0xfe, 0x00}},//Sharpness -1
	{{0xfe, 0x00},{0x95, 0x65},{0xfe, 0x00}},//Sharpness
	{{0xfe, 0x00},{0x95, 0x99},{0xfe, 0x00}},//Sharpness +1
	{{0xfe, 0x00},{0x95, 0x9a},{0xfe, 0x00}},//Sharpness +2
	{{0xfe, 0x00},{0x95, 0xff},{0xfe, 0x00}},//Sharpness +3
#endif
};
...
static struct msm_camera_i2c_reg_conf gc0310_reg_exposure_compensation[5][3] = {
	...
	{{0xfe, 0x01},{0x13, 0x35},{0xfe, 0x00}},//Exposure //0x3c
...
#ifndef DEBUG_SENSOR_GC
	/* Home: */
{0x42, 0xfd},{0x77, 0x4a},{0x78, 0x44},{0x79, 0x80},
#endif
};
//end white balance
...
// char camera_f_info[20];
//static char *moudle_name="gc0310"; 
...
//	ret=strcpy(camera_f_info, "gc0310");
//	printk("front camera is %s\n",camera_f_info);
	...
	void __user *argp)
{
	...
	case CFG_SET_SLAVE_INFO: {
		...
		int slave_index = 0;
		sensor_slave_info = kmalloc(sizeof(struct msm_camera_sensor_slave_info)*1, GFP_KERNEL);
