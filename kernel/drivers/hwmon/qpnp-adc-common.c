...
extern int tinno_fake_temp;
#endif

static const struct qpnp_vadc_map_pt Tinno_adcmap_btm_threshold[] = {
{-300  , 1618   },    
{-290  , 1609   },    
{-280  , 1600   },    
{-270  , 1591   },    
...
#ifdef FAKE_TEMP_DEBUG
       if(tinno_fake_temp>0)
       {
		adc_chan_result->physical=(tinno_fake_temp-30)*10;
		return 0;

	}else{
	return qpnp_adc_map_temp_voltage(
			Tinno_adcmap_btm_threshold,
			ARRAY_SIZE(Tinno_adcmap_btm_threshold),
			bat_voltage,
